...
func newChartMoveCmd() *cobra.Command {
	...
	f.StringVar(&toArchive, "to-intermediate-bundle", "", "save the chart and all its dependencies to an intermediate archive tarball")

	if err := cmd.Flags().MarkHidden("to-intermediate-bundle"); err != nil {
